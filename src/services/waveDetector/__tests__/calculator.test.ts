...
describe('WaveScoreCalculator', () => {
  ...
  beforeEach(() => {
    ...
    ;(StandingsCalculator as jest.Mock).mockImplementation(() => mockStandingsCalculator)
  ...
  describe('calculatePositionProximity', () => {
    ...
    it('should return 20 for teams in same position', async () => {
      ...
      const score = await (calculator as any).calculatePositionProximity(match, homeTeam, awayTeam)
  ...
  describe('calculateZoneImportance', () => {
    ...
    it('should return 20 for both teams in title race', async () => {
      ...
      const score = await (calculator as any).calculateZoneImportance(match, homeTeam, awayTeam)
      expect(score).toBe(20)
    })
  ...
  describe('calculateFormDifferential', () => {
    ...
    it('should return 15 for teams with very similar form', async () => {
      ...
      const score = await (calculator as any).calculateFormDifferential(match, homeTeam, awayTeam)
      expect(score).toBe(15)
    })

...
const DEFAULT_INCLUDE =
  'participants;scores;venue;state;league;season;stage;round;group;aggregate;statistics;events;periods;lineups;sidelined.sideline;metadata.type;weatherreport'
